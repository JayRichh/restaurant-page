import McButton from "./hamburger.js";
...
navButton.setAttribute("data", "pizza-menu");
navButton.setAttribute("href", "#");
navButton.classList.add("nav-button");
// Menu button elements
const navElement1 = document.createElement("b");
const navElement2 = document.createElement("b");
const navElement3 = document.createElement("b");
navButton.appendChild(navElement1);
navButton.appendChild(navElement2);
navButton.appendChild(navElement3);
...
inputHeader.textContent = "Subscribe to our newsletter for updates and offers";
...
// Imported McButton function from hamburger.js to handle the menu button animation
setTimeout(() => {
  // import { McButton } from "./hamburger.js";
  //McButton();
